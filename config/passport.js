//handles creating new users, checks if they already exists. Creates hash of users password and save user object
        ...
        process.nextTick(function(){  
            User.findOne({ 'twitter.id': profile.id }, function(err, user){  
                // Database error 
                    ...
                    // Found a user with this ID, they already have an account on this site.       // Return this user. 
                if (user) { 
